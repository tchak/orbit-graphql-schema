...
export interface Source extends OrbitSource, Queryable {}
...
export interface FindRecordParams extends Params {
  id?: string;
}

export interface FindRecordsParams extends Params {
  ids?: string[];
  where: Record<string, any>;
  orderBy?: SortQBParam;
}

export type QueryResult = OrbitRecord | OrbitRecord[] | null;
